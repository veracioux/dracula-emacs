...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default / basic faces
               ...
               (region :inherit match :extend t :foreground ,dracula-fg :background ,dracula-current :weight bold)
               ...
               ;; vterm
               (vterm-color-black :foreground "#1e1e1e")
               (vterm-color-red :foreground "#ff5555")
               (vterm-color-green :foreground "#54d1bc")
               (vterm-color-yellow :foreground "#f2b374")
               (vterm-color-blue :foreground "#6980fa")
               (vterm-color-magenta :foreground "#d098ff")
               (vterm-color-cyan :foreground "#8cceff")
               (vterm-color-white :foreground "#92aab7")
               (vterm-color-bright-black :foreground "#6b746b")
               (vterm-color-bright-red :foreground "#ff8c8c")
               (vterm-color-bright-green :foreground "#98eb98")
               (vterm-color-bright-yellow :foreground "#e0d97b")
               (vterm-color-bright-blue :foreground "#99a3ff")
               (vterm-color-bright-magenta :foreground "#f298c3")
               (vterm-color-bright-cyan :foreground "#a6d9ff")
               (vterm-color-bright-white :foreground "#dddddd")
               ;; TeX (auctex)
